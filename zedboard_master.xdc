...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS18 } [get_ports { Cin }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS18 } [get_ports { Cout }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
